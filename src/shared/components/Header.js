...
export default function Header({ onMenuClick, showMenuButton = true }) {
  ...
  return (
    <header className="z-20 flex shrink-0 items-center justify-between gap-3 bg-surface/60 px-3 pt-3 pb-2 backdrop-blur-xl border-b border-border-subtle lg:px-6">
      {/* Mobile menu button */}
